...
const CSS_HANDLES = ['changeImageText'] as const
...
const InputUpload = (props: FormRawInputProps & { accept?: string }) => {
  ...
  return (
    ...
    <div>
      ...
      {fileName && <ImageThumb image={imageUrl} />}

      {
        imageUrl && <div {...getRootProps()} className="flex flex-column">
          <input {...getInputProps()} />
          <p className={handles.changeImageText}>
            Change this file
          </p>
        </div>
